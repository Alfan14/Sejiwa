...
router.put('/bookings/:id', authenticate, authorize(['pelajar']),db_booking.updateBooking);
router.delete('/bookings/:id',authenticate, authorize(['pelajar']), db_booking.deleteBooking);
